...
export default function WestWynCounty() {
  return (
    ...
    >
      {/* Hero Section with Banner & Heading overlay */}
      ...
      <article className="max-w-7xl mx-auto mt-14 grid gap-14 grid-cols-1 md:grid-cols-2">
        ...
        <section className="md:col-span-2 bg-white rounded-3xl shadow-lg p-10 sm:p-14">
          ...
          >
            Welcome to <strong>WestWyn County</strong>, a premium plotted development nestled in
            the heart of <strong>Dholera Smart City</strong>. Designed for investors, families,
            and visionaries shaping the future, this project offers more than just land — it’s
            your gateway to India’s first and largest government-backed smart city
            transformation.
          </p>
        </section>

        {/* Cards Container */}
        <section className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {/* Card Base Styles */}
          {[
            {
          ...
          {/* Why Choose Card */}
          <div
            className="bg-white rounded-3xl shadow-md p-8 hover:shadow-xl transition-shadow duration-300 cursor-default sm:col-span-2 lg:col-span-1 flex flex-col"
          ...
          >
            ...
            <p className="mb-6 text-gray-700 leading-relaxed text-base font-serif">
              Whether you're a first-time buyer, an NRI, a parent securing your child's future,
              or a retiree planning peaceful years — WestWyn County offers:
            </p>
            <ul className="space-y-3 text-gray-700 list-disc list-inside text-base flex-grow">
        ...
        {/* Site Locations */}
        <section
          className="md:col-span-2 bg-white rounded-3xl shadow-lg p-10 sm:p-14 mt-8"
        ...
        >
          ...
          <address className="not-italic space-y-5 text-gray-700 max-w-3xl mx-auto text-base flex flex-col gap-3">
            <p>
              <strong>🏢 Head Office:</strong> Sector-63, Noida, Uttar Pradesh
            </p>
            <p>
              <strong>🏬 Corporate Office:</strong> JMD Megapolis, Gurugram, Haryana
            </p>
            <p>
              <strong>📍 Site Office:</strong> Fedra-Pipli Road, State Highway, Dholera, Gujarat
            </p>
          </address>
        </section>

        {/* Call to Action Button */}
        <section className="md:col-span-2 text-center mt-12">
          <a
            href="/contact"
